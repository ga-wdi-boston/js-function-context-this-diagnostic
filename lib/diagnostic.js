...
//     `true` or `false`
//
let access = true if keyword "this" is used within that new function on line 6 referencing laserQuantity variable and invoked on deathStar; // replace null with your response
//
...
//
let scopes = [fire, deathStar, global];
If method fire is called on deathStar and assinged into a global variable then
laserQuantity will have global scope too.
