...
let answer1 = 3; // or its 1 I don't know if num1 technically changes or not
...
let answer3 = person2.fullName(); // replace null with your response
...
let answer4 = deathStar.fire(); //not sure if alderaan should be a parameter passed to fire
// or if this is even correct?
// replace null with your response
