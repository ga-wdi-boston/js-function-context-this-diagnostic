...
//
let scopes = ['alderaan', 'deathStar', 'fire', 'global'];
//Note
//aldereann because all functions have access to global scope, second becaus eits inside of that functions
//
//
