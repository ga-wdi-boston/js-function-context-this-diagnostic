...
let answer3 = person.fullName.call(person2); // replace null with your response
...
alderaan.fire = deathStar.fire
let answer4 = alderaan.call(deathStar.fire());  // replace null with your response
