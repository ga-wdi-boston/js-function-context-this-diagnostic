...
let answer1 = undefined; // replace null with your response
...
let answer3 = fullName.call(person2); // replace null with your response
...
let answer4 = new deathStar();  // replace null with your response
